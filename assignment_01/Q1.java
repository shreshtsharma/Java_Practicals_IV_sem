...
public class Q1 {
	public static void main(String[] args) {
		...
		Student obj = new Student("ajay", 14, 'A', 88);
		Student obj1 = new Student("dev", 14, 'A', 78);
		Student obj2 = new Student("aryan", 12, 'A', 98);
		Student obj3 = new Student("Abhishek", 15, 'A', 38);
		Student obj4 = new Student("akash", 69, 'A', 58);
		Student obj5 = new Student("don", 18, 'A', 98);
		//Getting the result 
